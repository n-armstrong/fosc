...
NamedInterval('-M3')
------------------------------------------------------------------------------------------------------------ */
FoscNamedInterval : FoscInterval {
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    // INIT
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    var <number, <qualityString;
    classvar <acceptableQualityStrings, <qualityAbbreviationToQualityString;
    classvar <semitonesToQualityStringAndNumber;
    /* --------------------------------------------------------------------------------------------------------
    ...
    *new { |name='P1'|
        ...
        var numberString, number, sign, octaves, semitones, pair;
        namedPrototype = [this, FoscNamedIntervalClass];
        numberedPrototype = [Number, FoscNumberedInterval, FoscNumberedIntervalClass];
    }
    init {
